...
public class shoppingCarAdapter extends RecyclerView.Adapter<shoppingCarAdapter.ViewHolder>{
    ...
    private ShopDetailActivity shop;
    private TextView totalPrice;
    private String userID;
    private int currentProductNum;

    public shoppingCarAdapter(ArrayList<ShoppingCar> carItem, ShopDetailActivity shop,String userid) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.carItemDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dbDR = FirebaseFirestore.getInstance().document("/userShoppingCar/"+userID+"/totalProduct/"+holder.carItemName.getText().toString());
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            carItemImage =(ImageView) itemView.findViewById(R.id.imageView9);

            carItemName = (TextView) itemView.findViewById(R.id.textView16);
            carItemCategory= (TextView) itemView.findViewById(R.id.textView18);
            carItemPrice = (TextView) itemView.findViewById(R.id.textView20);
            carItemCount = (TextView) itemView.findViewById(R.id.textView21);

            carItemMinus = (Button) itemView.findViewById(R.id.button8);
            carItemPlus = (Button) itemView.findViewById(R.id.button9);
            carItemDelete = (Button) itemView.findViewById(R.id.button10);
        }
    }
    ...
    private void setTheTotalPrice(){
        ...
        dbCR.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                int totalPrice1 = 0;
                totalPrice = (TextView) shop.findViewById(R.id.textView22);
